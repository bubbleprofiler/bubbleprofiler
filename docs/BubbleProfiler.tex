...
\newcommand{\bptarpagelatest}{%
  \url{https://github.com/bubbleprofiler/bubbleprofiler/releases/latest/download/bubbleprofiler.tar.gz}\xspace}
\newcommand{\docspage}{%
...
\end{center}
%
To download and uncompress the version of \bp described in this paper, run at the command
line:
%
