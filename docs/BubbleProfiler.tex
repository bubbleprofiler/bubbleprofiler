...
with the analytic solution. This is because as $\Delta m \to 0$ the barrier vanishes and the analytic solution for the profile diverges at the origin
resulting in numerical problems.
For $\Delta m >
